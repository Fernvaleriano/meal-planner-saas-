...
const COMMON_FOODS = [
  ...
  { name: 'Pork Dumplings (steamed)', calories: 50, protein: 2.5, carbs: 5, fat: 2, servingSize: 1, servingUnit: 'piece' },
  { name: 'Shrimp Dumplings (steamed)', calories: 45, protein: 3, carbs: 4.5, fat: 1.5, servingSize: 1, servingUnit: 'piece' },
  { name: 'Fried Dumplings / Potstickers', calories: 70, protein: 3, carbs: 7, fat: 3.5, servingSize: 1, servingUnit: 'piece' },
  { name: 'Gyoza (pan-fried)', calories: 65, protein: 2.5, carbs: 7, fat: 3, servingSize: 1, servingUnit: 'piece' },
  { name: 'California Roll', calories: 255, protein: 9, carbs: 38, fat: 7, servingSize: 6, servingUnit: 'pieces' },
  { name: 'Salmon Nigiri', calories: 60, protein: 4, carbs: 8, fat: 1, servingSize: 1, servingUnit: 'piece' },
  { name: 'Pizza (Cheese)', calories: 270, protein: 12, carbs: 34, fat: 10, servingSize: 1, servingUnit: 'slice' },
  { name: 'Pizza (Pepperoni)', calories: 300, protein: 13, carbs: 34, fat: 13, servingSize: 1, servingUnit: 'slice' },
  { name: 'Chicken Burrito', calories: 580, protein: 32, carbs: 60, fat: 22, servingSize: 1, servingUnit: 'burrito' },
  { name: 'Beef Taco', calories: 210, protein: 10, carbs: 21, fat: 10, servingSize: 1, servingUnit: 'taco' },
  { name: 'Fried Rice', calories: 228, protein: 5.5, carbs: 32, fat: 8.5, servingSize: 200, servingUnit: 'g' },
  { name: 'Lo Mein (chicken)', calories: 310, protein: 14, carbs: 38, fat: 12, servingSize: 200, servingUnit: 'g' },
  { name: 'Pad Thai (shrimp)', calories: 360, protein: 14, carbs: 46, fat: 14, servingSize: 200, servingUnit: 'g' },
  { name: 'Spring Roll (fried)', calories: 110, protein: 3, carbs: 13, fat: 5, servingSize: 1, servingUnit: 'roll' },
  { name: 'Chicken Nuggets', calories: 48, protein: 2.5, carbs: 3, fat: 3, servingSize: 1, servingUnit: 'piece' },
  { name: 'Buffalo Chicken Wings', calories: 80, protein: 7, carbs: 0.5, fat: 5.5, servingSize: 1, servingUnit: 'wing' },
  { name: 'French Fries', calories: 365, protein: 4, carbs: 44, fat: 19, servingSize: 117, servingUnit: 'g' },
  { name: 'Cheeseburger', calories: 530, protein: 28, carbs: 40, fat: 28, servingSize: 1, servingUnit: 'burger' },
  { name: 'Pho (beef)', calories: 350, protein: 24, carbs: 42, fat: 8, servingSize: 1, servingUnit: 'bowl' },
  { name: 'Ramen (pork broth)', calories: 450, protein: 20, carbs: 55, fat: 16, servingSize: 1, servingUnit: 'bowl' },
  // Ethnic / cultural foods
  { name: 'Hummus', calories: 166, protein: 8, carbs: 14, fat: 10, servingSize: 100, servingUnit: 'g' },
  { name: 'Falafel', calories: 57, protein: 2.3, carbs: 5, fat: 3.4, servingSize: 1, servingUnit: 'piece' },
  { name: 'Naan Bread', calories: 260, protein: 9, carbs: 45, fat: 5, servingSize: 1, servingUnit: 'piece' },
  { name: 'Samosa (vegetable)', calories: 150, protein: 3, carbs: 18, fat: 7, servingSize: 1, servingUnit: 'piece' },
  { name: 'Empanada (beef)', calories: 280, protein: 10, carbs: 26, fat: 15, servingSize: 1, servingUnit: 'piece' },
  { name: 'Chicken Tikka Masala', calories: 300, protein: 22, carbs: 12, fat: 18, servingSize: 200, servingUnit: 'g' },
  { name: 'Bibimbap', calories: 490, protein: 22, carbs: 70, fat: 14, servingSize: 1, servingUnit: 'bowl' },
  { name: 'Chicken Shawarma (wrap)', calories: 520, protein: 30, carbs: 42, fat: 24, servingSize: 1, servingUnit: 'wrap' },
  // Breakfast items
  { name: 'Pancakes', calories: 175, protein: 5, carbs: 25, fat: 6, servingSize: 2, servingUnit: 'medium' },
  { name: 'Waffle', calories: 218, protein: 6, carbs: 25, fat: 11, servingSize: 1, servingUnit: 'waffle' },
  { name: 'French Toast', calories: 149, protein: 5, carbs: 16, fat: 7, servingSize: 1, servingUnit: 'slice' },
  { name: 'Breakfast Burrito', calories: 450, protein: 20, carbs: 40, fat: 22, servingSize: 1, servingUnit: 'burrito' },
  { name: 'Bagel (plain)', calories: 270, protein: 10, carbs: 53, fat: 1.5, servingSize: 1, servingUnit: 'bagel' },
  { name: 'Cream Cheese', calories: 50, protein: 1, carbs: 1, fat: 5, servingSize: 1, servingUnit: 'tbsp' },
  // Common snacks & beverages
  { name: 'Popcorn (air-popped)', calories: 31, protein: 1, carbs: 6, fat: 0.4, servingSize: 1, servingUnit: 'cup' },
  { name: 'Trail Mix', calories: 175, protein: 5, carbs: 16, fat: 11, servingSize: 30, servingUnit: 'g' },
  { name: 'Granola', calories: 210, protein: 5, carbs: 28, fat: 9, servingSize: 45, servingUnit: 'g' },
  { name: 'Orange Juice', calories: 112, protein: 2, carbs: 26, fat: 0.5, servingSize: 1, servingUnit: 'cup' },
  { name: 'Latte (whole milk)', calories: 190, protein: 10, carbs: 18, fat: 8, servingSize: 1, servingUnit: 'grande' },
  { name: 'Latte (oat milk)', calories: 170, protein: 5, carbs: 27, fat: 5, servingSize: 1, servingUnit: 'grande' },
  { name: 'Smoothie (fruit, protein)', calories: 250, protein: 20, carbs: 35, fat: 3, servingSize: 1, servingUnit: 'cup' },
  { name: 'Acai Bowl', calories: 380, protein: 6, carbs: 62, fat: 12, servingSize: 1, servingUnit: 'bowl' }
];
            ...
            data.parsed.forEach(item => {
              if (item.food && !seen.has(item.food.label.toLowerCase())) {
                ...
                results.push({
                  ...
                  potassium: Math.round((nutrients.K || 0) * multiplier),
                  calcium: Math.round((nutrients.CA || 0) * multiplier),
