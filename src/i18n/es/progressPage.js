...
export default {
  ...
  scanBp: 'Escanear presión arterial',
  bpScanning: 'Leyendo el monitor…',
  bpScanned: '¡Lectura capturada! Revisa los números y guarda.',
  bpScanFailed: 'No se pudo leer ese monitor. Prueba con una foto más clara o ingresa los números a mano.',
