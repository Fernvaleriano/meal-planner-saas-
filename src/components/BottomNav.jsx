...
import { Home, NotebookPen, Dumbbell, Utensils, User, Activity, Brain } from 'lucide-react';
...
function BottomNav({ currentPath }) {
  ...
  const navItems = [
    ...
    ...(isCoach ? [{ path: '/feed', icon: Activity, label: 'Feed' }] : [{ path: '/adaptive-coach', icon: Brain, label: 'Coach' }]),
