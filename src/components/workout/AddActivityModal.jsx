...
const STRETCH_KEYWORDS = [
  ...
  'front rack', 'lat floor', 'lats stretch on wall', 'lats stretch elbow',
  ...
  'corner wall', 'side chest stretch on wall',
  'exercise ball back', 'exercise ball hip flexor', 'exercise ball lat',
  'exercise ball lower back', 'exercise ball lying side',
  'exercise ball seated hamstring', 'exercise ball seated quad',
  'fixed bar stretch', 'band warm up shoulder',
  'resistance band assisted front rack',
  'calve stretch', 'calves stretch', 'calf push',
  'lunging straight leg calf', 'crouching heel back',
  ...
  'lying glute', 'lying hip flexor', 'lying quadriceps', 'lying side quadriceps',
  'seated calf', 'seated cross leg glute', 'seated shoulder flexor',
  'seated side', 'seated single leg', 'seated straight leg calf',
  'standing bow hamstring', 'standing gastrocnemius',
  'standing hamstring calf', 'standing lateral',
  'standing leg elevated', 'standing one arm chest',
  'standing overhand shoulder', 'standing quadriceps',
  'standing reverse shoulder', 'standing side slope',
  'standing adductor', 'adductor stretch', 'adductor dynamic',
  'abdominal stretch', 'above head chest', 'across chest shoulder',
  'backward abdominal', 'backward forward turn',
  'lying prone abdominal', 'chest opener',
  'side wrist pull', 'cable lat prayer',
  'alternating leg downward', 'armless prayer',
  'circles knee', 'dumbbell rdl stretch',
  'single arm extended pull downwards biceps',
  'single arm on wall side biceps', 'single arm palm down on wall',
  'both arms behind on wall biceps',
  'intermediate hip flexor', 'kneeling hip flexor',
  'kneeling lat', 'kneeling wrist',
  'hamstring lying curl', 'hamstring lying straight',
  'bulgarian split squat stretch',
  'leg extended stretch', 'legs hand reach spine',
  'runner stretch', 'plyo side lunge',
  'dynamic back', 'world greatest', 'worlds greatest',
  'all fours quad', 'chest stretch with exercise ball'
];
