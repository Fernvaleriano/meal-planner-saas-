        ...
        {loading ? (
          <div style={{ textAlign: 'center', padding: '48px 0 40px' }}>
            ...
            <div style={{ fontWeight: 700 }}>
              {progress ? `Building day ${progress.current} of ${progress.total}…` : 'Building your workout…'}
            </div>
            <div style={{ fontSize: 13, opacity: 0.6, marginTop: 4 }}>
              {progress ? 'A full program takes a couple of minutes — hang tight.' : 'This can take up to a minute'}
            </div>
          ...
          <>
            ...
            >
              <Dumbbell size={18} /> {planType === 'program' ? 'Generate program' : 'Generate workout'}
            </button>
          </>
        )}
      </div>
