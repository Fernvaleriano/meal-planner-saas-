...
// Weight conversion now lives in a single source of truth (src/utils/weight.js).
// Re-exported here so existing imports keep working with identical math.
export { convertWeight, toKg, fromKg } from './weight';
