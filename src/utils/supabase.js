...
// that held it. Since this is a single-tab SPA, cross-tab synchronization
// isn't needed; Supabase's own in-process lock is safe, handles re-entrancy
// correctly (its Promise-chain alone does not), and skips the navigator.locks
// steal behavior entirely.
